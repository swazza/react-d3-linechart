...
export const SWITCH_OFF_RESET_ON_ADD_POINT_FORM =
  'SWITCH_OFF_RESET_ON_ADD_POINT_FORM';

export interface SwitchOffResetOnAddPointFormAction {
  type: typeof SWITCH_OFF_RESET_ON_ADD_POINT_FORM;
}

export const switchOffResetOnAddPointForm = (): SwitchOffResetOnAddPointFormAction => ({
  type: SWITCH_OFF_RESET_ON_ADD_POINT_FORM
});
...
export type ActionTypes =
  ...
  | SwitchOffResetOnAddPointFormAction;
